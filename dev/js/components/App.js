    ...
    return (
      <section id='app'>
        ...
        <footer>
          ...
          <p><a onClick={() => logOutboundLink('paypal')} href='https://paypal.me/kennethlumalicay/3' target='_blank' rel='noopener noreferrer'>Buy me a coffee or help keep the server up and running.</a></p>
        </footer>
      </section>
    );
  }
